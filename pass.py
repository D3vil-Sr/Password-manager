...
# Represented as chars to enable easy string concatenation
    ...
    print(password)
        ...
        # pwdhash = binascii.hexlify(pwdhash) # hex: 0-f
        #  pwdHash = (salt + pwdhash).decode('ascii')
        # Store the password into file
...
"""
Salt: mde up of random bits(0, 1) added to each password instance before
its hashing . (auth0.com)
